                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(UserPwd.equals(PassCk)) {
                                if (success) {
                                    String greeting = UserName + "님 가입을 환영합니다";
                                    Toast toast = Toast.makeText(getApplicationContext(), greeting, Toast.LENGTH_SHORT);
                                    toast.show();
                                    ...
                                    Toast toast = Toast.makeText(getApplicationContext(), "회원가입에 실패하였습니다.", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            } else {
